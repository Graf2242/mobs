...
import Mechanics.SimpleArrayList;
...
public class IteratorMicroBenchmark {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        final SimpleArrayList<Integer> al = new SimpleArrayList<>(size);
        ...
        final List<Integer> sal = new ArrayList<Integer>(sv);
...
//                                sum += n;
//                            shortCheck.sum(sum);}}},
                new Job("SimpleArrayList get loop") {
                    public void work() throws Throwable {
                        for (int i = 0; i < iterations; i++) {
                            int sum = 0;
                            int size = al.size();
                ...
                new Job("SimpleArrayList iterate for loop") {
                    public void work() throws Throwable {
                        for (int i = 0; i < iterations; i++) {
                            int sum = 0;
                            for (Integer n : al)
...
//                new Job("SimpleArrayList descending listIterator loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < iterations; i++) {
//                            int sum = 0;
...
//                                sum += it.previous();
//                            check.sum(sum);}}},
                new Job("SimpleArrayList listIterator loop") {
                    public void work() throws Throwable {
                        for (int i = 0; i < iterations; i++) {
                            int sum = 0;
...
//                new Job("SimpleArrayList subList get loop") {
//                    public void work() throws Throwable {
...
//                                sum += sl.get(j);
//                            check.sum(sum);}}},
//                new Job("SimpleArrayList subList iterate for loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < iterations; i++) {
//                            int sum = 0;
...
//                                sum += n;
//                            check.sum(sum);}}},
//                new Job("SimpleArrayList subList subList subList iterate for loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < iterations; i++) {
//                            int sum = 0;
...
//                                sum += n;
//                            check.sum(sum);}}},
//                new Job("SimpleArrayList backwards wrapper ListIterator for loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < iterations; i++) {
//                            int sum = 0;
...
//                                sum += n;
//                            check.sum(sum);}}},
//                new Job("SimpleArrayList backwards wrapper subList ListIterator for loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < iterations; i++) {
//                            int sum = 0;
...
//                                sum += n;
//                            check.sum(sum);}}},
//          new Job("SimpleArrayList iterate desugared") {
//              public void work() throws Throwable {
//                  for (int i = 0; i < iterations; i++) {
//                      int sum = 0;
...
//                          sum += it.next();
//                      check.sum(sum);}}},
                new Job("Short SimpleArrayList get loop") {
                    public void work() throws Throwable {
                        for (int i = 0; i < (iterations * size / shortSize); i++) {
                            int sum = 0;
                            int size = sal.size();
                ...
                new Job("Short SimpleArrayList iterate for loop") {
                    public void work() throws Throwable {
                        for (int i = 0; i < (iterations * size / shortSize); i++) {
                            int sum = 0;
                            for (Integer n : sal)
...
//                new Job("Short SimpleArrayList sublist iterate for loop") {
//                    public void work() throws Throwable {
//                        for (int i = 0; i < (iterations * size / shortSize); i++) {
//                            int sum = 0;
...
//                                sum += n;
//                            shortCheck.sum(sum);}}},
                new Job("Vector SimpleArrayList alternating iteration") {
                    public void work() throws Throwable {
                        for (int i = 0; i < iterations; i++) {
                            int sum = 0;
                ...
                new Job("Vector SimpleArrayList alternating invokeVirtual iteration") {
                    public void work() throws Throwable {
                        for (int i = 0; i < iterations; i++) {
                            int sum = 0;
                            List<Iterator<Integer>> its
                                    = new SimpleArrayList<Iterator<Integer>>(2);
                            its.add(v.iterator());
                            its.add(al.iterator());
